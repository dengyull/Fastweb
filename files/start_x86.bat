@echo off
set "url=https://github.com/rustdesk/rustdesk/releases/download/1.3.1/rustdesk-1.3.1-x86-sciter.exe"
set "filename=rustdesk-1.3.1-x86-sciter.exe"
...
start "" "rustdesk-1.3.1-x86-sciter.exe"
